...
from DynSpecMS.Other import reformat
from DynSpecMS.Array import NpShared
import os
from DynSpecMS.Array import ModLinAlg
from DynSpecMS.Other.progressbar import ProgressBar

# is it good to have this stored in hard for an Add On ? Seems to be really specific
from DynSpecMS.Data import ClassLOFARBeam
from DynSpecMS.Data import ClassFITSBeam
from DynSpecMS.Data import ClassGMRTBeam
from DynSpecMS.Data import ClassATCABeam as ClassATCABeam
...
import hashlib
import DynSpecMS.Other.PrintList
...
class ClassJones():
    ...
    def GiveKillMSSols(self):
        ...
        for File, ThisGlobalMode, ThisJonesMode in zip(
            ...
            print("  VisToJonesChanMapping: %s" % DynSpecMS.Other.PrintList.ListToStr(VisToJonesChanMapping), file=log)
    ...
    def EstimateBeam(self, TimesBeam, RA, DEC,progressBar=True, quiet=False):
        ...
        if not quiet:
            print("VisToJonesChanMapping: %s"%DynSpecMS.Other.PrintList.ListToStr(DicoBeam["VisToJonesChanMapping"]), file=log)
